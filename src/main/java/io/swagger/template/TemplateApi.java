...
public class TemplateApi {
    public static void main(String[] args) throws Exception {
        ...
        for (Field iterator : fieldList) {
            ...
            FileWriter proxyFileWriter = new FileWriter(new File("/Users/prateekkoul/Downloads/Integration/src/main/java/io/swagger/api/"+iterator.get(integrationName) + "Proxy.java"));
            ...
            File myFoo = new File("/Users/prateekkoul/Downloads/Integration/src/main/java/io/swagger/api/"+iterator.get(integrationName)+"ApiController.java");
